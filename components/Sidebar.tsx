      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col h-full flex-shrink-0">
        ...
        <div className="p-4 border-t border-gray-200 space-y-3">
           <button 
              ...
              className="w-full flex items-center justify-center gap-2 text-xs font-medium text-gray-600 hover:text-indigo-600 bg-gray-50 hover:bg-gray-100 py-2 rounded-md transition-colors"
           >
